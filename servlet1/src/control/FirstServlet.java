...
public class FirstServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * out.print("<h1>" + id + "님 로그인 성공</h1>"); if(cArr != null) { for(String
		 * c:cArr) { out.print(c); //println보다 print로 해야 비용절감 out.print("<br>"); } }
		 */
		//out.print("<script>alert('로그인 성공'); location.href='jq/layout.html';</script>");
	}
